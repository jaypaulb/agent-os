...
load_configuration() {
    ...
    EFFECTIVE_TRACKING_MODE="${TRACKING_MODE:-$BASE_TRACKING_MODE}"
    EFFECTIVE_BEADS_ENABLED="${BEADS_ENABLED:-$BASE_BEADS_ENABLED}"
    ...
    print_verbose "  Issue Tracking Mode: $EFFECTIVE_TRACKING_MODE"
    print_verbose "  Beads Enabled: $EFFECTIVE_BEADS_ENABLED"
}
